...
const ProfileMenu: FC<Props> = () => {
  ...
  // Set role dynamically or from props/context if needed
  const role: "user" | "author" = "user"; // Change this assignment as needed
  const avatar = "";
  const signOut = () => {};
    ...
    <div className="flex items-center gap-4">
      <Dropdown placement="bottom-start">
        ...
        <DropdownMenu aria-label="User Actions" variant="flat">
          ...
          {/* Only render author section if role is "author" */}
          {role === "author" && (
            <DropdownSection showDivider>
