...
const SimpleNavbar = () => {
    ...
    const displayName = myProfile?.displayName || user?.username || user?.email || '';
                        ...
                        {user ? (
                            <>
                                <div className="flex items-center gap-2">
                                    <span className="hidden sm:inline text-sm text-gray-700"><span className="font-medium">Hi</span>{displayName ? `, ${displayName}` : ''}</span>
                                    <button onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
                                        <img src={myProfile?.photoUrl || avatarImg} alt="avatar" className="size-7 rounded-full object-cover ring-2 ring-blue-500" />
                                    </button>
                                </div>
